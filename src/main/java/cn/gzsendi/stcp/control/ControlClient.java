...
public class ControlClient extends Thread {
	...
	public ControlClient(String groupName,String typeName,String remoteHost,int remotePort){
	...
	public void connectServer() {
		...
		try {
			...
			String heartStr = "{\"msgType\":\"cotrolConnect\",\"token\":\""+token+"\",\"role\":\""+role+"\",\"groupName\":\""+groupName+"\"} ";
